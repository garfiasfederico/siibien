...
class ItarExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        //
        return InformeAccion::select("id","nombre","descripcion", "objetivo","dependencia.dependenciaSiglas","informe_acciones.p_entrega",DB::raw("count(ia_bs.idBS) as bienes_servicios"))

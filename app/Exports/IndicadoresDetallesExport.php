...
class IndicadoresDetallesExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        (select GROUP_CONCAT(valoresindicador.valoresReal SEPARATOR "\n") from valoresindicador where valoresindicador.idIndicador = indicador.idIndicador and valoresindicador.valoresAnioMedicion="2024") as M2024,
        ...
        (select GROUP_CONCAT(valoresindicador.valoresReal SEPARATOR "\n") from valoresindicador where valoresindicador.idIndicador = indicador.idIndicador and valoresindicador.valoresAnioMedicion="2025") as M2025,

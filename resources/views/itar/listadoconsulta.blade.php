                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">                                            
                                            @if($ppa->estadoPPA != "revision")
                                                <button class="btn btn-secondary" id="btnupt{{$ppa->id}}" disabled>Edición</button>
                                            @else
                                                <button class="btn btn-success"  id="btnupt{{$ppa->id}}" disabled>Revisión</button>
                                            @endif
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $("#optitar").css('background-color', "rgb(217, 217, 217)");
        });

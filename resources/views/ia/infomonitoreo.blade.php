            ...
            <table style="width: 100%">
                ...
                <tr class="">
                    <td class="enc1" colspan="16" style="text-align: right">
                        <button class="btn btn-primary" onclick="showCargaMunicipios({{$infoBS->idBS}})" @if(auth()->user()->enlace->idDependencia!=84) disabled @endif><i class="fas fa-arrow-up"></i> Desglose por municipios</button>

            ...
            @if($bss->count()>0)
                @foreach ($bss as $bs )
                    ...
                    @php
                        ...
                        $region3 = IABSRegion::where("idBS",$bs->idBS)->where("anio",$anio)->where("idRegion",4)->first();
                        $region4 = IABSRegion::where("idBS",$bs->idBS)->where("anio",$anio)->where("idRegion",5)->first();
                        $region5 = IABSRegion::where("idBS",$bs->idBS)->where("anio",$anio)->where("idRegion",3)->first();
